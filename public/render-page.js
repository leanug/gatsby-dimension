...
var plugins = [{
  ...
  options: {
    "plugins": [],
    "fonts": ["Source Sans Pro:300", "poppins:300,500"],
    "display": "swap"
  }
}, {
...
/* harmony import */ var _src_components_BackToTopBtn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/components/BackToTopBtn */ "./src/components/BackToTopBtn.js");
/* harmony import */ var _src_components_BackgroundImage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/components/BackgroundImage */ "./src/components/BackgroundImage.js");
/* harmony import */ var _src_components_GlobalStyles__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./src/components/GlobalStyles */ "./src/components/GlobalStyles.js");
...
const wrapPageElement = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_src_components_GlobalStyles__WEBPACK_IMPORTED_MODULE_4__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_src_components_BackToTopBtn__WEBPACK_IMPORTED_MODULE_2__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_src_components_BackgroundImage__WEBPACK_IMPORTED_MODULE_3__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_src_components_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], props, element));
};
...
/***/ "./src/components/BackToTopBtn.js":
/*!****************************************!*\
  !*** ./src/components/BackToTopBtn.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _icons_ChevronUp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icons/ChevronUp */ "./src/components/icons/ChevronUp.js");
...
const BackToTopBtn = () => {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_icons_ChevronUp__WEBPACK_IMPORTED_MODULE_1__["default"], null));
};

const Button = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].button.withConfig({
  displayName: "BackToTopBtn__Button"
})(["align-items:center;background-color:var(--clr-delta);border:none;border-radius:50%;bottom:2rem;color:var(--clr-psi);cursor:pointer;display:flex;font-size:2rem;height:48px;justify-content:center;line-height:1;margin:auto;opacity:0;position:fixed;right:2rem;transition:all 0.25s linear;width:48px;z-index:50;&:hover{box-shadow:", ";}", ""], ({
  theme
}) => theme.darkShadow, ({
  showButton
}) => {
  return showButton ? (0,styled_components__WEBPACK_IMPORTED_MODULE_2__.css)(["opacity:1;"]) : (0,styled_components__WEBPACK_IMPORTED_MODULE_2__.css)(["opacity:0;z-index:0;"]);
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BackToTopBtn);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _public_page_data_sq_d_2486734986_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/page-data/sq/d/2486734986.json */ "./public/page-data/sq/d/2486734986.json");
...
/* harmony import */ var gbimage_bridge__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gbimage-bridge */ "./node_modules/gbimage-bridge/dist/index.modern.js");
...
const GbiBridged = () => {
  const {
    placeholderImage
  } = _public_page_data_sq_d_2486734986_json__WEBPACK_IMPORTED_MODULE_0__.data;
  const url = typeof window !== 'undefined' ? window.location.href : '';

  if (url) {
    const check = /^https?\:\/\/[^\/]+\/?$/.test(url);
  }

  const image = (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_4__.getImage)(placeholderImage);
  const bgImage = (0,gbimage_bridge__WEBPACK_IMPORTED_MODULE_3__.convertToBgImage)(image);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(gatsby_background_image__WEBPACK_IMPORTED_MODULE_2__["default"], Object.assign({
    Tag: "section"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GbiBridged);
...
const Globals = (0,styled_components__WEBPACK_IMPORTED_MODULE_0__.createGlobalStyle)([":root{--primary-font:\"Source Sans Pro\",Helvetica,Arial,sans-serif;--secondary-font:\"Poppins\",Helvetica,Arial,sans-serif;--radius-alpha:0.5rem;--radius-beta:1rem;--radius-gamma:2rem;--line-height-alpha:1.8;--line-height-beta:2;--max-width:132rem;--clr-alpha:#0075E9;--clr-beta:#F2F9FF;--clr-gamma:rgb(229,229,229);--clr-delta:rgba(27,31,34,0.85);--clr-omega:#131313;--clr-psi:#FFFFFF;--shadow:drop-shadow(0px 0px 10px rgba(0,0,0,.1));--transition:all 0.2s linear;}*,::after,::before{margin:0;padding:0;box-sizing:inherit;}html{box-sizing:border-box;font-size:62.5% !important;}body{color:var(--clr-psi);font-family:var(--primary-font);font-size:1.6rem;line-height:var(--line-height-alpha);transition:color 0.25s linear;}.wrapper{max-width:var(--max-width);margin:auto;padding-left:1.5rem;padding-right:1.5rem;width:100%;}.wrapper-fluid{padding-left:calc(2rem + 4vw);padding-right:calc(2rem + 4vw);@media screen and ( max-width:576px ){padding:0 2rem;}}.header-1,h1,.header-2,h2,.header-3,h3,.header-4,h4,.header-5,h5,.header-6,h6{display:inline-block;font-family:var(--secondary-font);font-weight:400;line-height:var(--line-height-alpha);letter-spacing:4px;margin-bottom:4rem;text-transform:uppercase;}h2{border-bottom:1px solid var(--clr-psi);}a{border-bottom:1px dotted;color:var(--clr-psi);cursor:pointer;text-decoration:none;transition:border-bottom 0.2s linear;}a:hover{border-bottom:0;text-decoration:none;}a.button:hover{text-decoration:none;}p:not(:last-of-type){margin-bottom:3rem;}.button{border:none;border-radius:3rem;color:var(--clr-omega);cursor:pointer;font-weight:600;padding:1.4rem 2.2rem;}.section-header{align-items:center;display:flex;justify-content:end;}picture{img{border-radius:var(--radius-alpha);}}.mb-40{margin-bottom:4rem;}"]);
...
const Layout = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PageWrapper, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", null, children), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("footer", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Designed by: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "https://html5up.net"
  }, "HTML5 UP")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "IMAGES: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
    href: "https://www.unsplash.com"
  }, "Unsplash")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "Developed by: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
...
})(["align-items:center;display:grid;grid-template-rows:1fr 2rem;justify-content:center;min-height:100vh;padding:4rem 0;main,footer{z-index:10;}main{margin-bottom:4rem;}footer{font-size:1.2rem;text-align:center;text-transform:uppercase;span{margin:0 0.8rem;}}"]);
Layout.propTypes = {
...
const ChevronUp = props => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", Object.assign({
  width: 35,
  height: 35,
  viewBox: "0 0 21 21",
...
/***/ "react-dom/server":
/*!***************************************************************************************!*\
  !*** external "/home/leanug/Gatsby/react-dimension/node_modules/react-dom/server.js" ***!
  \***************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/home/leanug/Gatsby/react-dimension/node_modules/react-dom/server.js");

/***/ }),

/***/ "react":
/*!**********************************************************************************!*\
  !*** external "/home/leanug/Gatsby/react-dimension/node_modules/react/index.js" ***!
  \**********************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/home/leanug/Gatsby/react-dimension/node_modules/react/index.js");
...
/***/ "./public/page-data/sq/d/2486734986.json":
/*!***********************************************!*\
  !*** ./public/page-data/sq/d/2486734986.json ***!
  \***********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"data":{"placeholderImage":{"childImageSharp":{"gatsbyImageData":{"layout":"constrained","placeholder":{"fallback":"data:image/jpeg;base64,"},"images":{"fallback":{"src":"/static/cda1e146f9c782d942f36a7b706c2b5e/987ab/lucas-ludwig-vMxMkOgbUwU-unsplash.jpg","srcSet":"/static/cda1e146f9c782d942f36a7b706c2b5e/3f4ea/lucas-ludwig-vMxMkOgbUwU-unsplash.jpg 600w,\\n/static/cda1e146f9c782d942f36a7b706c2b5e/8dbcc/lucas-ludwig-vMxMkOgbUwU-unsplash.jpg 1200w,\\n/static/cda1e146f9c782d942f36a7b706c2b5e/987ab/lucas-ludwig-vMxMkOgbUwU-unsplash.jpg 2400w","sizes":"(min-width: 2400px) 2400px, 100vw"},"sources":[{"srcSet":"/static/cda1e146f9c782d942f36a7b706c2b5e/9ff6b/lucas-ludwig-vMxMkOgbUwU-unsplash.webp 600w,\\n/static/cda1e146f9c782d942f36a7b706c2b5e/f2559/lucas-ludwig-vMxMkOgbUwU-unsplash.webp 1200w,\\n/static/cda1e146f9c782d942f36a7b706c2b5e/15fc2/lucas-ludwig-vMxMkOgbUwU-unsplash.webp 2400w","type":"image/webp","sizes":"(min-width: 2400px) 2400px, 100vw"}]},"width":2400,"height":1600}}}}}');
